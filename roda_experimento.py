...
def rodar_experimento(caminho_instancia, pasta_resultados, iteracoes=500, tamanho_populacao=100, num_execucoes=30, parada_estagnacao=100):
    ...
    # Salva estatísticas em um arquivo
    ...
    # Os gráficos salvam na pasta resultados
